...
mix.js('resources/assets/js/credentials/credentials.js', 'public/assets/js/credentials/credentials.js').version();
mix.js('resources/assets/js/laboratories/laboratories.js', 'public/assets/js/laboratories/laboratories.js').version();

mix.js('resources/assets/js/turboImplement.js', 'public/js/turbo.js');


 mix.js('resources/assets/js/settings/settings.js', 'public/assets/js/settings/settings.js').version();
